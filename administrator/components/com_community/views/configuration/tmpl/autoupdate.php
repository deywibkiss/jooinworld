		...
		<tbody>
			<tr>
				<td width="350" class="key">
					<span class="hasTip" title="::<?php echo JText::_('COM_COMMUNITY_CONFIGURATION_AUTOUPDATE_ORDERCODE'); ?>">
			...
			<tr>
				<td class="key">
					<span class="hasTip" title="::<?php echo JText::_('COM_COMMUNITY_CONFIGURATION_AUTOUPDATE_EMAIL'); ?>">
            ...
            <tr>
				...
				<td valign="top">                    
                    ...
                    <p><img src="<?php echo COMMUNITY_ASSETS_URL; ?>/images/notice-success.png"> Your current JomSocial is up to date</p>
                    <?php else: ?>
