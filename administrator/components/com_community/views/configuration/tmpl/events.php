...
<fieldset class="adminform">
	...
	<a href="http://tiny.cc/jsevents" target="_blank"><?php echo JText::_('COM_COMMUNITY_DOC'); ?></a>
	<table class="admintable" cellspacing="1">
		<tbody>
			<tr>
				<td width="350" class="key">
					<span class="hasTip" title="::<?php echo JText::_('COM_COMMUNITY_CONFIGURATION_EVENTS_ENABLE_EVENTS_TIPS'); ?>">
			...
			<tr>
				<td width="350" class="key">
					<span class="hasTip" title="::<?php echo JText::_('COM_COMMUNITY_CONFIGURATION_EVENTS_ENABLE_GUEST_SEARCH_TIPS'); ?>">
			...
			<tr>
				<td width="350" class="key">
					<span class="hasTip" title="::<?php echo JText::_('COM_COMMUNITY_CONFIGURATION_EVENTS_MODERATE_EVENT_TIPS'); ?>">
			...
			<tr>
				<td class="key">
					<span class="hasTip" title="::<?php echo JText::_('COM_COMMUNITY_CONFIGURATION_EVENTS_ALLOW_CREATION_TIPS'); ?>">
			...
			<tr>
				<td class="key">
					<span class="hasTip" title="::<?php echo JText::_('COM_COMMUNITY_CONFIGURATION_EVENTS_CREATE_LIMIT_TIPS'); ?>">
			...
			<tr>
				<td class="key">
					<span class="hasTip" title="::<?php echo JText::_('COM_COMMUNITY_CONFIGURATION_EVENTS_ICAL_EXPORT_TIPS'); ?>">
			...
			<tr>
				<td class="key">
					<span class="hasTip" title="::<?php echo JText::_('COM_COMMUNITY_CONFIGURATION_EVENTS_ICAL_IMPORT_TIPS'); ?>">
			...
			<tr>
				<td class="key">
					<span class="hasTip" title="::<?php echo JText::_('COM_COMMUNITY_CONFIGURATION_EVENTS_SHOW_MAPS_TIPS'); ?>">
            ...
            <tr>
				<td class="key">
					<span class="hasTip" title="::<?php echo JText::_('COM_COMMUNITY_CONFIGURATION_EVENTS_DEFAULT_RADIUS_TIPS'); ?>">
				...
				<td>       	
					...
					<label for="eventradiusmeasure_1"><?php echo JText::_('COM_COMMUNITY_EVENTS_KILOMETRE');?></label>
			...
			<tr>
				<td class="key">
					<span class="hasTip" title="::<?php echo JText::_('COM_COMMUNITY_CONFIGURATION_EVENTS_NEARBY_RADIUS_TIPS'); ?>">
			...
			<tr>
				<td class="key">
					<span class="hasTip" title="::<?php echo JText::_('COM_COMMUNITY_CONFIGURATION_EVENTS_CALENDAR_FIRST_DAY_TIPS'); ?>">
...
<fieldset class="adminform">
	...
	<table class="admintable" cellspacing="1">
		<tbody>
			<tr>
				<td class="key">
					<span class="hasTip" title="::<?php echo JText::_('COM_COMMUNITY_CONFIGURATION_EVENTS_LISTINGS_DATE_FORMAT_TIPS'); ?>">
			...
			<tr>
				<td class="key">
					<span class="hasTip" title="::<?php echo JText::_('COM_COMMUNITY_CONFIGURATION_EVENTS_TIME_SELECTION_FORMAT_TIPS'); ?>">
			...
			<tr>
				<td class="key">
					<span class="hasTip" title="::<?php echo JText::_('COM_COMMUNITY_CONFIGURATION_EVENTS_SHOW_TIMEZONE_TIPS'); ?>">
