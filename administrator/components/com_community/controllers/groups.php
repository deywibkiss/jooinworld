...
<table cellspacing="0" class="admintable" border="0" width="100%">
	<tbody>
		...
		<tr>
			<td class="key" valign="top"><span class="hasTip" title="<?php echo JText::_('COM_COMMUNITY_GROUPS_NEW_OWNER_TIPS');?>"><?php echo JText::_('COM_COMMUNITY_GROUPS_NEW_OWNER');?></span></td>
			<td align="left">
				<?php
				if($rows)
				{
...
<table cellspacing="0" class="admintable" border="0" width="100%">
	<tbody>
		<tr>
			<td class="key" valign="top"><span class="hasTip" title="<?php echo JText::_('COM_COMMUNITY_ASSIGN_GROUPS_TIPS');?>"><?php echo JText::_('COM_COMMUNITY_GROUPS');?></span></td>
			<td>
...
<?php
		...
		$action = '<input type="button" class="button saveButton" onclick="azcommunity.saveGroup();" name="' . JText::_('COM_COMMUNITY_SAVE') . '" value="' . JText::_('COM_COMMUNITY_SAVE') . '" />';
		$action .= '&nbsp;<input type="button" class="button cancelButton" onclick="cWindowHide();" name="' . JText::_('COM_COMMUNITY_CLOSE') . '" value="' . JText::_('COM_COMMUNITY_CLOSE') . '" />';
		$response->addScriptCall( 'cWindowActions' , $action );
