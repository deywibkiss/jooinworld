...
<?php
		...
		$buttons = '<input type="button" class="button saveButton" onclick="javascript:azcommunity.submitZencoderAccount();return false;" value="' . JText::_('COM_COMMUNITY_ZENCODER_SUBMIT_BUTTON') . '"/>';
