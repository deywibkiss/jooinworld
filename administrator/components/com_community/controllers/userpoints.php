...
<form action="#" method="post" name="editRule" id="editRule">
	<table cellspacing="0" class="admintable" border="0" width="100%">
		<tbody>
			...
			<tr>
				<td class="key"><span class="hasTip" title="<?php echo JText::_('COM_COMMUNITY_USERPOINTS_USER_ACCESS_TIPS');?>"><?php echo JText::_('COM_COMMUNITY_USERPOINTS_USER_ACCESS');?></span></td>
				<td>
					<span>
						<?php echo $group; ?>
					</span>
			...
			<tr>
				<td class="key"><span class="hasTip" title="<?php echo JText::_('COM_COMMUNITY_USERPOINTS_PUBLISHED_TIPS');?>"><?php echo JText::_('COM_COMMUNITY_PUBLISHED');?></span></td>
				<td>
					<span><?php echo $this->_buildRadio($row->published, 'published', array('Yes', 'No'));?></span>
				</td>
			</tr>
			<tr>
				<td class="key"><span class="hasTip" title="<?php echo JText::_('COM_COMMUNITY_USERPOINTS_POINTS_TIPS');?>"><?php echo JText::_('COM_COMMUNITY_USERPOINTS_POINTS');?></span></td>
				<td>
...
<?php
		...
		$buttons	= '<input type="button" class="button saveButton" onclick="javascript:azcommunity.saveRule(\'' . $row->id . '\');return false;" value="' . JText::_('COM_COMMUNITY_SAVE') . '"/>';
...
<?php
		...
		if(count($newRules) > 0)
		$buttons	.= '<input type="button" class="button saveButton" onclick="javascript: location.reload();return false;" value="' . JText::_('COM_COMMUNITY_USERPOINTS_REFRESH') . '"/>';
		$buttons	.= '<input type="button" class="button cancelButton" onclick="javascript:cWindowHide();" value="' . JText::_('COM_COMMUNITY_CANCEL') . '"/>';
		$response->addAssign( 'cWindowContent' , 'innerHTML' , $contents );
		$response->addScriptCall( 'cWindowActions' , $buttons );
		return $response->sendResponse();
