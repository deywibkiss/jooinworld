...
class CommunityControllerEvents extends CommunityController
{
	...
	<?php
		...
		$action = '<input type="button" class="button saveButton" onclick="azcommunity.saveGroupOwner();" name="' . JText::_('COM_COMMUNITY_SAVE') . '" value="' . JText::_('COM_COMMUNITY_SAVE') . '" />';
...
<div style="background-color: #F9F9F9; border: 1px solid #D5D5D5; margin-bottom: 10px; padding: 5px;">
	<?php echo JText::sprintf('COM_COMMUNITY_GROUP_ASSIGN_MEMBER', $user->getDisplayName());?>
		...
		$action = '<input type="button" class="button saveButton" onclick="azcommunity.saveAssignGroup();" name="' . JText::_('COM_COMMUNITY_SAVE') . '" value="' . JText::_('COM_COMMUNITY_SAVE') . '" />';
		$action .= '<input type="button" class="button cancelButton" onclick="cWindowHide();" name="' . JText::_('COM_COMMUNITY_CLOSE') . '" value="' . JText::_('COM_COMMUNITY_CLOSE') . '" />';
		$response->addScriptCall('cWindowActions', $action);
...
<form name="editevent" action="" method="post" id="editevent">
	...
	<table cellspacing="0" class="admintable" border="0" width="100%">
		...
		<tr>
			<td class="key"><span class="hasTip" title="<?php echo JText::_('COM_COMMUNITY_PUBLISH_EVENT_TIPS')?>"><?php echo JText::_('COM_COMMUNITY_PUBLISH_STATUS');?></span></td>
			<td>
				<input type="radio" name="published" value="1"
					   id="publish" <?php echo ($event->published == '1') ? 'checked="true"' : '';?>/>
				<label for="publish"><?php echo JText::_('COM_COMMUNITY_PUBLISH'); ?></label>
				<input type="radio" name="published" value="0"
					   id="unpublish" <?php echo ($event->published == '0') ? 'checked="true"' : '';?>>
				<label for="unpublish"><?php echo JText::_('COM_COMMUNITY_UNPUBLISH');?></label>
			</td>
		</tr>
		<tr>
			<td class="key"><span class="hasTip" title="<?php echo JText::_('COM_COMMUNITY_CATEGORY_EVENT_TIPS')?>"><?php echo JText::_('COM_COMMUNITY_CATEGORY');?></span></td>
			<td>
				<select name="catid">
					<?php
		...
		<tr>
			<td class="key"><span class="hasTip" title="<?php echo JText::_('COM_COMMUNITY_NAME_EVENT_TIPS')?>"><?php echo JText::_('COM_COMMUNITY_NAME');?></span<</td>
			<td>
				<span>
		...
		<tr>
			<td class="key"><span class="hasTip" title="<?php echo JText::_('COM_COMMUNITY_DESC_EVENT_TIPS')?>"><?php echo JText::_('COM_COMMUNITY_DESCRIPTION');?></span></td>
			<td>
...
<?php
		...
		$action = '<input type="button" class="button saveButton" onclick="azcommunity.saveEvent();" name="' . JText::_('COM_COMMUNITY_SAVE') . '" value="' . JText::_('COM_COMMUNITY_SAVE') . '" />';
		$action .= '&nbsp;<input type="button" class="button cancelButton" onclick="cWindowHide();" name="' . JText::_('COM_COMMUNITY_CLOSE') . '" value="' . JText::_('COM_COMMUNITY_CLOSE') . '" />';
		$response->addScriptCall('cWindowActions', $action);
