...
<table cellspacing="0" class="admintable" border="0" width="100%">
	<tbody>
		<tr>
			<td class="key"><span class="hasTip" title="<?php echo JText::_('COM_COMMUNITY_COSTUMPROFILE_NAME_TIPS');?>"><?php echo JText::_('COM_COMMUNITY_NAME');?></span></td>
			<td>
				<input type="text" value="<?php echo $row->name;?>" name="name" style="width:250px;" />
			</td>
		</tr>
		<tr>
			<td class="key"><span class="hasTip" title="<?php echo JText::_('COM_COMMUNITY_COSTUMPROFILE_PUBLISHED_TIPS');?>"><?php echo JText::_('COM_COMMUNITY_PUBLISHED');?></span></td>
			<td>
		...
		<tr>
			<td class="key"><span class="hasTip" title="<?php echo JText::_('COM_COMMUNITY_COSTUMPROFILE_VISIBLE_TIPS');?>"><?php echo JText::_('COM_COMMUNITY_VISIBLE');?></span></td>
...
<?php
		...
		$buttons	= '<input type="button" class="button saveButton" onclick="javascript:azcommunity.saveFieldGroup(\'' . $row->id . '\');return false;" value="' . JText::_('COM_COMMUNITY_SAVE') . '"/>';
		$buttons	.= '&nbsp;&nbsp;<input type="button" class="button cancelButton" onclick="javascript:cWindowHide();" value="' . JText::_('COM_COMMUNITY_CANCEL') . '"/>';
...
<table cellspacing="0" class="paramlist admintable" border="0" width="100%">
	<tbody>
		<tr>
			<td class="key"><span class="hasTip" title="<?php echo JText::_('COM_COMMUNITY_PROFILE_NAME_TIPS');?> "><?php echo JText::_('COM_COMMUNITY_NAME');?></span> <span class="required-sign">*</span></td>
			<td>
				<input type="text" value="<?php echo CStringHelper::escape( $row->name );?>" name="name" />
			</td>
		</tr>
		<tr>
			<td class="key"><span class="hasTip" title="<?php echo JText::_('COM_COMMUNITY_PROFILE_TYPE_TIPS');?> "><?php echo JText::_('COM_COMMUNITY_TYPE');?></span></td>
		...
		<tr style="<?php echo ($row->type != 'group') ? 'display: table-row;' : 'display: none;'; ?>" class="fieldGroups">
			<td class="key"><span class="hasTip" title="<?php echo JText::_('COM_COMMUNITY_PROFILE_GROUPS_TIPS');?> "><?php echo JText::_('COM_COMMUNITY_GROUPS');?></span></td>
			<td colspan="4">
				<select name="group">
			<?php
		...
		<tr>
			<td class="key"><span class="hasTip" title="<?php echo JText::_('COM_COMMUNITY_PROFILE_FIELD_TIPS');?> "><?php echo JText::_('COM_COMMUNITY_FIELD_CODE');?> </span><span class="required-sign">*</span></td>
			<td><input type="text" value="<?php echo CStringHelper::escape( $row->fieldcode ); ?>" name="fieldcode" maxlength="255" /></td>
		</tr>

		<tr>
			<td valign="top" class="key"><span class="hasTip" title="<?php echo JText::_('COM_COMMUNITY_PROFILE_REGISTRATION_TIPS');?> "><?php echo JText::_('COM_COMMUNITY_REGISTRATION');?></span></td>
			<td colspan="4">
		...
		<tr>
			<td class="key"><span class="hasTip" title="<?php echo JText::_('COM_COMMUNITY_PROFILE_VISIBLE_TIPS');?> "><?php echo JText::_('COM_COMMUNITY_VISIBLE');?></span></td>
			<td><?php echo $this->_buildRadio($row->visible, 'visible', array( JText::_('COM_COMMUNITY_PROFILEFIELD_PERSONAL_OPTION'), JText::_('COM_COMMUNITY_PROFILEFIELD_ALL_OPTION'), JText::_('COM_COMMUNITY_PROFILEFIELD_ADMINONLY_OPTION')));?></td>
		</tr>
		<tr>
			<td class="key"><span class="hasTip" title="<?php echo JText::_('COM_COMMUNITY_PROFILE_PUBLISHED_TIPS');?> "><?php echo JText::_('COM_COMMUNITY_PUBLISHED');?></span></td>
			<td>
				<span><?php echo $this->_buildRadio($row->published, 'published', array( JText::_('COM_COMMUNITY_NO_OPTION'),JText::_('COM_COMMUNITY_YES_OPTION')));?></span>
			</td>
		</tr>
		<tr>
			<td class="key"><span class="hasTip" title="<?php echo JText::_('COM_COMMUNITY_PROFILE_REQUIRED_TIPS');?> "><?php echo JText::_('COM_COMMUNITY_REQUIRED');?></span></td>
		...
		<tr>
			<td valign="top" class="key"><span class="hasTip" title="<?php echo JText::_('COM_COMMUNITY_PROFILE_TOOLTIP_TIPS');?> "><?php echo JText::_('COM_COMMUNITY_TOOLTIP');?></span></td>
			<td colspan="4">
...
<?php
		$contents	= ob_get_contents();
		ob_end_clean();
		$buttons	= '<input type="button" class="button saveButton" onclick="javascript:azcommunity.saveField(\'' . $row->id . '\');return false;" value="' . JText::_('COM_COMMUNITY_SAVE') . '"/>';
		$buttons	.= '&nbsp;&nbsp;<input type="button" class="button cancelButton" onclick="javascript:cWindowHide();" value="' . JText::_('COM_COMMUNITY_CANCEL') . '"/>';
		$response->addAssign( 'cWindowContent' , 'innerHTML' , $contents );
		$response->addAssign( 'cwin_logo' , 'innerHTML' , $windowTitle );
		$response->addScriptCall( 'cWindowActions' , $buttons );
	...
	public function _buildOptions(& $row, $id, $type)
	{
		...
		$html	.= '	<td class="key" valign="top">
							<span class="hasTip" title="'.JText::_('COM_COMMUNITY_PROFILE_OPTIONS_TIPS').'">Option</span><br />
						</td>
						<td colspan="4">';
