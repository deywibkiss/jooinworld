...
<form action="<?php echo CRoute::getURI(); ?>" method="post" id="jomsForm" name="jomsForm" class="community-form-validate">
	<div class="ctitle">
		<h2><?php echo JText::_('COM_COMMUNITY_REGISTER_TITLE_USER_INFO'); ?><
		/h2>
	</div>
...
?>
		...
		<li>
			...
			<div class="form-field">
				<input type="text" id="jslastnamemsg" name="jslastname" value="<?php echo $data['html_field']['jslastname']; ?>" class="input text required validate-jslastname" style="width: 70%" />
		...
		<li>
			...
			<div class="form-field">
				<input placeholder="Nombre" type="text" name="jsname" id="jsname" value="<?php echo $data['html_field']['jsname']; ?>" class="input text required validate-name" style="width: 43%" />
				<span id="errjsnamemsg" style="display:none;">&nbsp;</span>

				<input placeholder="Nombre de Usuario" type="text" id="jsusername" name="jsusername" value="<?php echo $data['html_field']['jsusername']; ?>" class="input text  required validate-username" style="width: 43%" />
		...
		<li>
			...
			<div class="form-field">
				<input placeholder="Correo Electrónico" type="text" id="jsemail" name="jsemail" value="<?php echo $data['html_field']['jsemail']; ?>" class="input text required validate-email" style="width: 87%" />
		...
		<li>
			...
			<div class="form-field">
				<input placeholder="Contraseña" class="input password required validate-password" type="password" id="jspassword" name="jspassword" style="width: 87%" />
		...
		<li>
			...
			<div class="form-field">
				<input placeholder="Vuelva a escribir su contraseña" class="input password  required validate-passverify" type="password" id="jspassword2" name="jspassword2" style="width: 87%" />
...
?>
	...
	?>
		...
		<li>
			<div id="terminos">
				Haciendo clic en Registrarse, estás indicando que has leído y que aceptas los Términos y Condiciones de servicio y las Políticas de Privacidad de jooinworld.com
			</div>
		</li>
		<li class="form-action has-seperator">
			<div class="form-field btn-registrarse">
				<input class="btn btn-success validateSubmit" type="submit" id="btnSubmit" value="<?php echo JText::_('Registrarse'); ?>" name="submit" />
				<?php if ( $fbHtml ) {
?>
...
<?php echo addslashes(JText::_("COM_COMMUNITY_ENTRY_MISSING")); ?>
	');
	cvalidate.setSystemText('JOINTEXT','
<?php echo addslashes(JText::_("COM_COMMUNITY_AND")); ?>
	');
	...
	'texts' : {
	1 : '
<?php echo addslashes(JText::_('COM_COMMUNITY_PASSWORD_STRENGHT_L1')); ?>
	',
	2 : '
<?php echo addslashes(JText::_('COM_COMMUNITY_PASSWORD_STRENGHT_L2')); ?>
	',
	3 : '
<?php echo addslashes(JText::_('COM_COMMUNITY_PASSWORD_STRENGHT_L3')); ?>
	',
	4 : '
<?php echo addslashes(JText::_('COM_COMMUNITY_PASSWORD_STRENGHT_L4')); ?>
	',
	5 : '
<?php echo addslashes(JText::_('COM_COMMUNITY_PASSWORD_STRENGHT_L5')); ?>
	'
	}
	}
