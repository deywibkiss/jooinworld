...
<div class="js-focus">
	<div class="js-focus-cover">
		<img id='<?php echo $event->id; ?>' class="focusbox-image cover-image" src="<?php echo $event->getCover(); ?>" alt="cover photo">
		...
		<?php if( $isMine || COwnerHelper::isCommunityAdmin() || $isAdmin ){?>
			<!-- Change cover button -->
			<div class="js-focus-change-cover btn" onclick="joms.cover.select(this, <?php echo $event->id; ?>);" data-cover-context="event" data-cover-type="cover">
