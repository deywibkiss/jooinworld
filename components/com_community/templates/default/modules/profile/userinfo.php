...
<div class="js-focus">
	<div class="js-focus-cover">
		<img id='<?php echo $profile->id; ?>' class="focusbox-image cover-image" src="<?php echo $profile->cover; ?>" alt="cover photo">
		...
		<!-- Change cover button -->
		<div class="js-focus-change-cover btn" onclick="joms.cover.select(this, <?php echo $profile->id; ?>);" data-cover-context="profile" data-cover-type="cover">
