	...
	SliderKit = function() {
		...
		this._change = function( eventSrc, scrollWay, goToId, lineScrolling, stopAuto ) {
			...
			if(eventSrc){
				...
				eventSrc.addClass(this.cssNames.btnDisable)
			}
				...
				if( this.scrollActive && !stopGoing ){
					...
					if(eventSrc)
					{
						...
						setInterval(function(){
							if(eventSrc.hasClass('cSlider-btn-disable'))
							{
								eventSrc.removeClass('cSlider-btn-disable');
								clearInterval();
							}
						},3000);
					}
					//setInterval(function(){if(eventSrc.hasClass(this.cssNames.btnDisable)){eventSrc.removeClass(this.cssNames.btnDisable);clearInterval();}},5000);
				}
