	...
	gallery:{
		...
		urlPhotoId: function(photoId){
			if (photoId==undefined)
			{
				...
				//if(window.history.pushState && jsPlaylist.customSetting.defaultId != photoId)
				//if(window.history.pushState && jsPlaylist.customSetting.defaultId != photoId)
				if(window.history.pushState)
				{
					window.history.pushState('string', 'title', jsPlaylist.photos[joms.gallery.getPlaylistIndex(photoId)].sefURL);
				}
			}
		},
		init: function(){
