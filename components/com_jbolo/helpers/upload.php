...
class uploadHelper
//class UploadHandler//original class name
{
	protected $options;
	...
	protected function initialize()
	{
		switch ($_SERVER['REQUEST_METHOD']) {
			...
			case 'POST':
				//$this->post();
				return $this->post();//changed by manoj
				break;
			case 'DELETE':
				$this->delete();
				break;
	...
	public function post($print_response = true)
	{
		...
		$this->prepareChatMsgs($files);//added by manoj
	...
	protected function get_file_name($name, $type, $index, $content_range,$uploaded_file)//manoj
	{
	 ...
	 protected function trim_file_name($name, $type, $index, $content_range,$uploaded_file) {
	...
	protected function get_unique_filename($name, $type, $index, $content_range,$uploaded_file)//manoj
	{
	   //echo "=". $uploaded_file; echo "=". $name; echo "=". $type;
		//echo "=". $index;  echo "=". $content_range;die;
		//dev plans.xlsx
